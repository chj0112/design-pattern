...
public class MainWindow extends FrameWindow implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == updateTextFieldObserverButton) {
            ...
            else if (updateTextFieldObserverButton.getText().equals(TEXTFIELD_OBSERVER_BUTTON_TITLE_ADD)) {
                primeThread.registerObserver(textFieldWindow);
            ...
            else if (updateLabelObserverButton.getText().equals(LABEL_OBSERVER_BUTTON_TITLE_ADD)) {
                primeThread.registerObserver(labelWindow);
